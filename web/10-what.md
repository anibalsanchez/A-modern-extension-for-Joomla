...
Developed with [reveal.js](https://github.com/hakimel/reveal.js).
    ...
    # .lando.yml
    #
    name: A-modern-extension-for-Joomla

    proxy:
      html:
        - A-modern-extension-for-Joomla.lndo.site
    services:
      html:
        type: apache:2.2
        webroot: web
...
<!-- .element: class="small" --><https://github.com/anibalsanchez/A-modern-extension-for-Joomla>


## This presentation - lando start <!-- .slide: class="extly-slide-style plain console" -->

    anibal@local-server:~/A-modern-extension-for-Joomla$ lando start
    ...
    NAME       A-modern-extension-for-Joomla
    LOCATION   /home/anibal/A-modern-extension-for-Joomla
    SERVICES   html
    HTML URLS  http://localhost:8080
               http://localhost:32818
               http://A-modern-extension-for-Joomla.lndo.site
               https://A-modern-extension-for-Joomla.lndo.site
